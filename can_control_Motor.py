...
class ros_node(Node):
    ...
    def subCmdCB(self,msg):
        ...
        if (self.Vy < 0.05 and self.Vy > - 0.05):
            self.Vy = 0.0
        if (self.Omega < 0.05 and self.Omega > - 0.05):
            self.Omega = 0.0
    ...
    def pub_callback(self):
        ...
        if (Vx_back < 0.05 and Vx_back > - 0.05):
            Vx_back = 0.0
        if (Vy_back < 0.05 and Vy_back > - 0.05):
            Vy_back = 0.0
        if (Vyaw_back < 0.05 and Vyaw_back > - 0.05):
            Vyaw_back = 0.0
        # Position of robot
